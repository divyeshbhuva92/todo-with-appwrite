...
export default function EditContact() {
  ...
  const formik = useFormik({
    initialValues: {
      ...contactToEdit,
      user_img: contactToEdit.user_img || "",
      first_name: contactToEdit.first_name || "",
      last_name: contactToEdit.last_name || "",
      mobile_num: contactToEdit.mobile_num || "",
      email: contactToEdit.email || "",
      country: contactToEdit.email || "",
      states: contactToEdit.states || "",
    ...
    onSubmit: (val) => {
      const editCntct = databases.updateDocument(
        dbID,
        collID,
        currentContactID,
        {
